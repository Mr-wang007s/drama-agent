---
description: |
  DramaAgent 正文写作规范：基于 EP01-EP04 实战沉淀的硬约束。
...
来源：jiu-ge EP01-EP04 实战复盘（详见 `.codebuddy/skills/drama-director/references/pipeline-lessons.md`）。
...
#### 实战验证基线（jiu-ge EP01-EP04）

| 集 | 字数 | Critic | Error | 修订轮次 | 主要教训 |
|---|---:|---:|---:|---:|---|
| EP01 | 4168 | 89 | 0 | 1 | 字数偏低 |
| EP02 | 4767 | 88 | 0 | 3 | 破折号 24/8、字数未达标 |
| EP03 | 4972 | 89 | 0 | 3 | 字数未达标、Over-Connect "往"字 |
| EP04 | 6699 | 89 | 1 | 2 | **前集伪造台词**（A5 违反）|

本规则从 EP05 起强制执行。违反 A 级约束须在本轮修订解决，违反 B 级约束须在 Critic 报告中列为 Warning 并给出修订建议。

---

#### 附录：常见陷阱示例（EP01-EP04 真实数据）
...
| 场景类型 | 参考字数 | 参考段数 | 出处 |
|---|---:|---:|---|
| 独角戏（无对话） | 5000-5800 | 120-140 | EP02 工地夜 |
| 一对一对话 | 2000-2400 | 50-60 | EP04·S3 周文渊办公室 |
| 短对话 + 长独白 | 1700-2000 | 40-55 | EP04·S1 车程 |
| 多人场景 | 1500-1800 | 40-50 | EP03 张教授+陆九+板房 |
